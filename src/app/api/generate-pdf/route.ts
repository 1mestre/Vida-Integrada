...
const getContractHtml = (clientName: string, date: string) => {
  ...
  // We build the full HTML as a string. This is pure TypeScript.
  const componentHtml = `
    <div class="pdf-page-container">
      <div class="main-content-wrapper">
        <header style="margin-top: 45mm; color: #105652; font-family: 'Montserrat', sans-serif; text-align: center; margin-bottom: 15mm;">
        ...
        <h3 style="font-size: 13.2pt; color: #105652; border-bottom: 1px solid #ccc; padding-bottom: 5px; margin-bottom: 10mm; font-weight: bold;">
