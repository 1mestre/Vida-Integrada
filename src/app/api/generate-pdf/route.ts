...
const getContractHtml = (clientName: string, date: string): string => {
  // Aquí va tu plantilla HTML exacta, la que diseñaste.
  return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
      ...
      <style>
        body { width: 210mm; min-height: 297mm; position: relative; background-color: #e8e5df; background-image: url("https://www.transparenttextures.com/patterns/light-paper-fibers.png"); font-family: 'Poppins', sans-serif; padding: 20mm; box-sizing: border-box; color: #333333; margin: 0; overflow: hidden; }
        ...
        .contact-info { position: absolute; bottom: 55mm; left: 50%; transform: translateX(-50%); text-align: center; font-size: 11pt; color: #555555; width: fit-content; z-index: 5; }
    ...
    <body>
        ...
        <img src="https://cdn.worldvectorlogo.com/logos/fiverr-2.svg" alt="Fiverr Logo" class="fiverr-logo">
